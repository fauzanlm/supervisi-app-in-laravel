...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['middleware' => 'supervisor'], function(){
        ...
        Route::get('/supervisor/nilai/post/{id}', [SupervisorController::class, 'nilaipost'])->name('supervisor.nilai.post');
        Route::get('/supervisor/nilai/tidaklulus/post/{id}', [SupervisorController::class, 'nilaitidakluluspost'])->name('supervisor.nilai.tidaklulus.post');
    });
